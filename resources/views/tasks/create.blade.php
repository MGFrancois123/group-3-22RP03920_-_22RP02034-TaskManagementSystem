                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ $project ? route('projects.show', $project) : route('tasks.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
